...
public class Roller implements IRoller<ForgeableItem> {
    ...
    public ForgeableItem rollItem(ForgeRecipe recipe) {
        ...
        Collections.shuffle(forgeableItems);
        this.recipe = recipe;
        return roll(forgeableItems);
    }
    ...
    @Override
    public ForgeableItem roll(List<ForgeableItem> forgeableItems) {
